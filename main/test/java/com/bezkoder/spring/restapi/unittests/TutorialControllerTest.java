...
public class TutorialControllerTest {
  ...
  @Test
  public void testGetTutorialByIdNotFound() {
    when(tutorialService.findById(1L)).thenReturn(null);
    assertThrows(RuntimeException.class, () -> tutorialController.getTutorialById(1L));
  }
  ...
  public void testUpdateTutorialNotFound() {
    Tutorial tutorial = new Tutorial();
    when(tutorialService.findById(1L)).thenReturn(null);
    assertThrows(RuntimeException.class, () -> tutorialController.updateTutorial(1L, tutorial));
  }
}